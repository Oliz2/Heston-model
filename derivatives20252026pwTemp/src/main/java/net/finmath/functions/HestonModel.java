...
public class HestonModel {
	...
	private static Complex hestonCharacteristicFunctionGradient(
		...
		final net.finmath.fouriermethod.models.HestonModel modelCF = 
				new net.finmath.fouriermethod.models.HestonModel(initialStockValue, riskFreeRate, sigma, theta, kappa, xi, rho);
		final Complex f = modelCF.apply(optionMaturity).apply(zeta);
